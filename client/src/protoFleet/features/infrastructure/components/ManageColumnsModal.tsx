      ...
      <div className="flex flex-col gap-6">
        <div className="flex items-center gap-4">
          ...
          <div className="ml-auto flex items-center gap-3">
            <Button text="Reset to defaults" variant={variants.secondary} size={sizes.base} onClick={handleReset} />
            <Button text="Save" variant={variants.primary} size={sizes.base} onClick={() => onSave(draft)} />
          </div>
        </div>
